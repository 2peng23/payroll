...
Route::group(['namespace'=>'Admin','as'=>'admin.'],function(){
	...
	Route::group(['middleware'=>'auth'],function(){
		...
		Route::get('/employee/archives/data',[EmployeeController::class,'archives'])->name('employee.archives');
		Route::get('/employee/archives/data/restore/{id}',[EmployeeController::class,'employee_restore'])->name('employee.restore');
		Route::post('/employee/deduction/{id}',[EmployeeController::class,'employee_deduction'])->name('employee.deduction');
		...
		Route::get('payslip/send/emails/{from}/{to}',"ReportController@mail_payslip")->name('payslip.mail');
		...
		Route::group(['as'=>'reports.','prefix'=>'report'],function(){
			...
			Route::get('/payslip', [ReportController::class,'payslip'])->name('payslip');
		});
