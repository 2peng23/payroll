...
use App\{Deduction, Employee, EmployeeDeduction, Schedule,Position};
...
class EmployeeController extends Controller
{
    ...
    public function employee_deduction(Request $request,$id){
         $deductions = $request->deduction_id;
         foreach($deductions as $deduction){
            $de = EmployeeDeduction::firstOrNew(['employee_id'=>$id,'deduction_id'=>$deduction]);
            $de->save();
         }
    ...
    public function archives()
    {
        ...
        return view('admin.employee.archives',compact('employees'));
    }
    ...
    {   
        ...
        if($trash){
            return response()->json([
                'status' => true,
                'message' => "Record has been moved to archives!",
