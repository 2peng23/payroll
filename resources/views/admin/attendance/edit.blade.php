  ...
  <div class="row align-items-end">
     <div class="col-lg-8">
        <div class="page-header-title">
           ...
           <div class="d-inline">
              <h5>Attenance</h5>
              <span>Edit Attenance, Please fill all field correctly.</span>
          </div>
      </div>
  </div>
  <div class="col-lg-4">
    <nav class="breadcrumb-container" aria-label="breadcrumb">
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item">
             <a href="{{ route('admin.overtime.index') }}">Attenance</a>
         </li>
         <li class="breadcrumb-item">
             <a href="#">Edit</a>
         </li>
        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                <div class="overlay hidden">
                    ...
                    <span class="overlay-text">Attenance Updating...</span>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <div class="state">
                        <h5 class="text-secondary">Edit Attenance</h5>
                    </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 col-lg-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control datetimepicker-input" id="time_in" data-toggle="datetimepicker" data-target="#time_in" name="time_in" data-value="{{ $attendance->time_in }}">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control datetimepicker-input" id="time_out" data-toggle="datetimepicker" data-target="#time_out" name="time_out" data-value="{{ $attendance->time_out }}">
