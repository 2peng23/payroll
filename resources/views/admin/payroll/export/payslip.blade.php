...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Payslips {{ $date }} | Payroll System - A System for HR Payment Generator. </title>
    <style type="text/css">
      body {
          position: relative;
          width: auto;  
  ...
  <body>
    <div class="card border-1">
          <div class="card-header">
              <h2 class="text-center border-top-bootom-1 py-4">Payroll System - EMPLOYEE PAYMENT SLIPS</h2>
