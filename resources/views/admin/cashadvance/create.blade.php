                    ...
                    <div class="row">
                      <div class="col-md-8 col-lg-8 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="title" placeholder="Some Title or Reason of Cash Advance" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-md-12 col-lg-12 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="rate_amount" class="form-control allowDcNum" id="rate_amount" placeholder="00.00" autocomplete="off">
