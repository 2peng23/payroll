                    ...
                    <div class="row">
                      <div class="col-md-8 col-lg-8 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="title" placeholder="Some Title or Reason of Overtime" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="rate_amount" class="form-control" id="rate_amount" placeholder="00.00" autocomplete="off">
