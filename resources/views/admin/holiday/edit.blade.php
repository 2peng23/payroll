        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Holiday</h5>
                        <span>Edit Holiday, Please fill all field correctly.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="widget overflow-visible">
                ...
                <div class="widget-body">
                    <div class="overlay hidden">
                        ...
                        <span class="overlay-text">Holiday {{ $holiday->name }} Updating...</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="Holiday">
                            <h5 class="text-secondary">Edit {{ $holiday->name }} Holiday</h5>
                        </div>
                    </div>

                    <form action="{{ route('admin.holiday.update', $holiday->id) }}" method="POST" id="editHoliday">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">Date</label><small class="text-danger">*</small>
                            <input type="date" name="date" class="form-control" id="name"
                                placeholder="ex: Standard Holiday" autocomplete="off" value="{{ $holiday->date }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" placeholder="Some description about holiday...">{{ old('description', $holiday->description) }}</textarea>
                        ...
                        <a href="{{ route('admin.holiday.index') }}" class="btn btn-light"><i
