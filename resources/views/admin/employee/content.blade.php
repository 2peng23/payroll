  ...
  <div class="tab-pane fade active show" id="live" role="tabpanel" aria-labelledby="pills-timeline-tab">
    ...
    <div class="card-header">
      ...
      <div class="col-md-6">
        ...
        <button type="submit" class="btn btn-primary  h-33  move-to-delete-all" id="apply" disabled="true" data-href="{{ $moveToTrashAllLink }}">Action</button>
        <a class='btn btn-secondary' href="{{ route('admin.employee.archives') }}"> <i class="fa fa-database"></i> Archives</a>
      </div>
      </div>
    </div>
