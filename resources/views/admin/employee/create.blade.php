            ...
            <div class="widget-body">
                ...
                <form action="{{ $form_store }}" method="POST" enctype="multipart/form-data" id="createEmployee">
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Cardo" autocomplete="off">
                      ...
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Dalisay" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="email" name="email" class="form-control" id="email" placeholder="cardodalisay@example.com" autocomplete="off">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="form-group">
                          ...
                          <small class="text-danger err" id="phone-err">Do not include 0. Start with 9.</small>
                        </div>
                      </div>
                      <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       <div class="form-group">
                        <label for="rate_per_hour">Rate Per Day</label><small class="text-danger">*</small>
                        <input type="text" name="rate_per_hour" class="form-control" id="rate_per_hour" placeholder="00.00" autocomplete="off">
                        <small class="text-danger err" id="rate_per_hour-err">It's important for Payroll calculation.</small>
                      </div>
                      </div>
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       <div class="form-group">
                        <label for="salary">Salary</label><small class="text-danger">*</small>
                        <input type="text" name="salary" class="form-control" id="salary" placeholder="00.00" autocomplete="off">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-6 col-sm-12" id="add-avatar-div">
                        <div class="form-group">
                          ...
                          <small class="text-danger err" id="media-err">*Please add the picture of employee.</small> 
                        </div>
                      </div>
