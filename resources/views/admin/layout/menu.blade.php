<div class="nav-container">
    <nav id="main-menu-navigation" class="navigation-main">
        ...
        <div class="nav-lavel bg-light">Management</div>
        <div
        ...
        <div class="nav-item has-sub {{ request()->routeIs('admin.attendance.*') ? 'active open' : '' }}">
            <a href="javascript:void(0)"><i class="ik ik-calendar"></i><span>Attendance</span>
            </a>
            <div class="submenu-content">
        ...
        <!--<div class="nav-item {{ request()->routeIs(['admin.payroll.*']) ? 'active' : '' }}">
            <a href="{{ route('admin.payroll.index') }}"><i class="ik ik-pie-chart"></i><span>Payroll</span></a>
        </div>-->

        <div class="nav-item {{ request()->routeIs(['admin.payroll.*']) ? 'active' : '' }}">
            <a href="{{ route('admin.reports.index') }}"> <i class="ik ik-bar-chart-2"></i> <span>Reports</span></a>
        </div>

        <div class="nav-lavel bg-light">Settings</div>


        <div class="nav-item has-sub {{ request()->routeIs('admin.holiday.*') ? 'active open' : '' }}">
            <a href="javascript:void(0)"><i class="ik ik-calendar"></i><span>Holidays</span>

            </a>
            <div class="submenu-content">
                <a href="{{ route('admin.holiday.create') }}"
                    class="menu-item {{ request()->routeIs('admin.holiday.create') ? 'active' : '' }}"><i
                        class="ik ik-plus-circle"></i>Add New Holiday</a>
                <a href="{{ route('admin.holiday.index') }}"
                    class="menu-item {{ request()->routeIs('admin.holiday.index') ? 'active' : '' }}"><i
                        class="ik file-text ik-file-text"></i>List Of Holidays</a>
            </div>
        </div>
        ...
        <div class="nav-lavel bg-light">Account</div>
