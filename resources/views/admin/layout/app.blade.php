...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('admin_assets/plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('admin_assets/plugins/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css') }}">
    ...
    <link rel="stylesheet"
        href="{{ asset('admin_assets/plugins/owl.carousel/dist/assets/owl.theme.default.min.css') }}">
...
<body>
    ...
    <div class="wrapper">
                        ...
                        <div class="dropdown">
                            <a class="dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar"
                                    src="{{ asset('admin_assets/avatars/admin/user.png') }}" alt=""></a>
        ...
        <div class="page-wrap">
            <div class="app-sidebar b-l-danger ">
                <div class="sidebar-header">
                    <a class="header-brand" href="{{ url('/') }}">
                        <div class="logo-img">
                            <img style='width:40px;border-radius:50%' src="{{ asset('images/blmc.jpg') }}"
                                alt="">
                        </div>
                        <small class="text pl-2"><b> BLMC </b><b>PayrollSystem</b></small>
                    </a>
            ...
            <footer class="footer">
                <div class="w-100 clearfix">
                    <span class="text-center text-sm-left d-md-inline-block">{{ config('app.name') }}</span>
    ...
    <script src="{{ asset('admin_assets/plugins/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js') }}">
    </script>
    <script src="{{ asset('admin_assets/plugins/moment/moment.js') }}"></script>
    <script src="{{ asset('admin_assets/plugins/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js') }}">
    </script>
